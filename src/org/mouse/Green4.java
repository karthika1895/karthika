...
public class Green4 {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement btnData = driver.findElement(By.xpath("//span[text()='Web Designing Training']"));
		acc.moveToElement(btnData).perform();;
		Thread.sleep(2000);
	    WebElement btnMicro = driver.findElement(By.xpath("//span[text()='JavaScript Training']"));
		btnMicro.click();
